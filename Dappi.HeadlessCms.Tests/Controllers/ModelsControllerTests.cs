...
namespace Dappi.HeadlessCms.Tests.Controllers
{
    public class ModelsControllerTests : BaseIntegrationTestFixture, IDisposable
    {
        ...
        public async Task CreateModel_Should_Create_Model_File()
        {
            ...
            _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(CreateModel_Should_Create_Model_File)}");
        ...
        public async Task AddField_Should_Add_Required_Field_To_Model(string fieldName, string fieldType)
        {
         ...
         public async Task AddField_Should_Add_OneToOne_Relation_To_Models()
         {
             ...
             await _client.PostAsJsonAsync(_baseUrl, new ModelRequest { ModelName = type1, IsAuditableEntity = false });
             await _client.PostAsJsonAsync(_baseUrl, new ModelRequest { ModelName = type2, IsAuditableEntity = false });
             ...
             _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(AddField_Should_Add_OneToOne_Relation_To_Models)}");
             await Verify(dbContext, _verifySettings).UseFileName("dbContext");
         ...
         public async Task AddField_Should_Add_OneToMany_Relation_To_Models()
         {
             ...
             _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(AddField_Should_Add_OneToMany_Relation_To_Models)}");
             await Verify(dbContext, _verifySettings).UseFileName("dbContext");
             await Verify(file1, _verifySettings).UseFileName("file1");
             await Verify(file2, _verifySettings).UseFileName("file2");
             await Verify(res, _verifySettings).UseFileName("response");
         ...
         public async Task AddField_Should_Add_ManyToOne_Relation_To_Models()
         {
             ...
             _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(AddField_Should_Add_ManyToOne_Relation_To_Models)}");
             await Verify(dbContext, _verifySettings).UseFileName("dbContext");
             await Verify(file1, _verifySettings).UseFileName("file1");
             await Verify(file2, _verifySettings).UseFileName("file2");
             await Verify(res, _verifySettings).UseFileName("response");
         ...
         public async Task AddField_Should_Add_ManyToMany_Relation_To_Models()
         {
             ...
             _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(AddField_Should_Add_ManyToMany_Relation_To_Models)}");
             await Verify(dbContext, _verifySettings).UseFileName("dbContext");
             await Verify(file1, _verifySettings).UseFileName("file1");
             await Verify(file2, _verifySettings).UseFileName("file2");
             await Verify(res, _verifySettings).UseFileName("response");
         ...
         public async Task DeleteModel_Should_Delete_Model_File()
         {
             ...
             _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(DeleteModel_Should_Delete_Model_File)}");
             await Verify(dbContext, _verifySettings).UseFileName("dbContext");
             await Verify(res, _verifySettings).UseFileName("response");
         }
         ...
         public async Task DeleteModel_Should_Delete_Relations_And_References()
         {
             ...
             await _client.PostAsJsonAsync(_baseUrl, new ModelRequest { ModelName = user, IsAuditableEntity = false });
             await _client.PostAsJsonAsync(_baseUrl, new ModelRequest { ModelName = post, IsAuditableEntity = false });
             ...
             _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(DeleteModel_Should_Delete_Relations_And_References)}");
         ...
         public async Task Other_Relations_Should_Not_Be_Deleted()
         {
             ...
             await _client.PostAsJsonAsync(_baseUrl, new ModelRequest { ModelName = user, IsAuditableEntity = false });
             await _client.PostAsJsonAsync(_baseUrl, new ModelRequest { ModelName = post, IsAuditableEntity = false });
             await _client.PostAsJsonAsync(_baseUrl, new ModelRequest { ModelName = comment, IsAuditableEntity = false });
             ...
             _verifySettings.UseDirectory($"{_snapshotPath}/{nameof(Other_Relations_Should_Not_Be_Deleted)}");
