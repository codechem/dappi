...
public class UserDtoValidatorTests
{
    ...
    [Theory]
    [MemberData(
        nameof(UserDtoValidatorTestData.InvalidNameTestCases),
        MemberType = typeof(UserDtoValidatorTestData)
    )]
    ...
    [Theory]
    [MemberData(
        nameof(UserDtoValidatorTestData.InvalidEmailTestCases),
        MemberType = typeof(UserDtoValidatorTestData)
    )]
    ...
    [Theory]
    [MemberData(
        nameof(UserDtoValidatorTestData.InvalidRolesTestCases),
        MemberType = typeof(UserDtoValidatorTestData)
    )]
...
public class UserRolesUpdateDtoValidatorTests
{
    ...
    [Theory]
    [MemberData(
        nameof(UserRolesUpdateDtoValidatorTestData.InvalidRolesTestCases),
        MemberType = typeof(UserRolesUpdateDtoValidatorTestData)
    )]
    public void Should_have_error_for_invalid_Roles(
        UserRolesUpdateDto model,
        string expectedErrorMessage
    )
    {
        var result = _validator.TestValidate(model);

        result.ShouldHaveValidationErrorFor(x => x.Roles).WithErrorMessage(expectedErrorMessage);
    }

    [Fact]
    public void Should_not_have_error_for_valid_Roles()
    {
        var model = new UserRolesUpdateDto { Roles = [TestUserRoles.User] };
