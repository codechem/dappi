...
namespace Dappi.SourceGenerator.Generators
{
    public static class ActionsGenerator
    {
        ...
        public static string GenerateGetByIdAction(
        ...
        public static string GenerateGetAction(
            List<CrudActions> crudActions,
            SourceModel item,
            string includesCode
        )
        ...
        public static string GenerateGetAllAction(
            List<CrudActions> crudActions,
            SourceModel item,
            string includesCode
        )
        ...
        public static string GeneratePostAction(
            List<CrudActions> crudActions,
            SourceModel item,
        ...
        public static string GeneratePatchAction(
            List<CrudActions> crudActions,
            SourceModel item,
            string includesCode
        )
        ...
        public static string GeneratePostActionForMediaInfo(
            List<CrudActions> crudActions,
            SourceModel item
        )
        {
        ...
        public static string GenerateDeleteAction(
            List<CrudActions> crudActions,
            SourceModel item,
            string includeCode,
            string removeCode
